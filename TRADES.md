...
_Last updated: 2026-04-27 (Monday Pre-Market Scan)_
...
|--------|--------|-------------|-----------|------------|-----------------|
| —      | —      | —           | —         | —          | No qualifying candidates — pre-market screen found only one $0.50–$5.00 mover ≥5% (DKI +26.21%), disqualified HIGH DILUTION RISK (PIPE at $0.35/share). Monday aggregation pending full 8:45 AM scan. |
...
- **CDXS ⚠️ EARNINGS DATE CORRECTION:** Q1-2026 earnings now confirmed **May 7, 2026** after close (StockTitan/Codexis IR confirmed), NOT April 30 as noted in Apr-22 and Apr-24 scan entries. EARNINGS <7D flag is now INACTIVE (10 days to report). Apr-25 close $2.62 (+3.97% on 1.75M vol); RVOL improving. Tech Score 4/5 maintained. Monitor for premarket/intraday RVOL ≥2.0 today.
- **IFRX:** Apr-22 last confirmed close $1.60; Apr-23/24 prices ~$1.48–$1.53 per StockTitan. Volume fading from Apr-22 spike (967K). RVOL now estimated <2.0 — re-confirm intraday.
- **ABCL:** Apr-24 close $4.16 (+2.62%); Apr-20 close $3.91 (last confirmed full-session data). Earnings May-11-26 confirmed. RVOL not confirmed above 2.0 premarket today.
- **AXSM (PDUFA NOTE — NOT in range):** AXS-05 PDUFA date **April 28, 2026** (Alzheimer's disease agitation). AXSM trades at ~$190 — disqualified by price ceiling. Monitor only as broad biotech sentiment driver.
- **BTAI:** Apr-24 close $1.06; Apr-26 intraday ~$1.09–$1.12. No significant move. PDUFA Nov-14-26 unchanged. RVOL ~0.5 — well below threshold.
- **ATNM:** Apr-24 close ~$1.28 (vol 177K vs avg ~700K = RVOL ~0.25). RVOL failing threshold. Earnings May-8-26 still on calendar.

---

### 2026-04-22 Afternoon Scan
...
|--------|-------|------|-----------|--------|-----------|-----------|------------|-------------|-----------|-----------|---------|---------|-------|----------------|----------|----------|---------|---------|
| CDXS | $2.60 | ~2.8 | $3.69M | ~1.5% | 3 | Y | Y | Y | Y | $3.10 | $3.87 | +158% | EARNINGS APR-30 ⚠️ CORRECTED — SEE APR-27 PRE-MARKET NOTE: EARNINGS NOW MAY-7-26 | 10-K/Q confirmed; EPS beat +357% Mar-11-26 | N/A | ~~Apr-30-26~~ **May-7-26** | Y ($6.71 avg, 13 analysts) | N |
| BTAI | $1.06 | ~2.1 | ~$1.1M | ~2.0% | 3 | Y | Y | N | Y | $1.40 | $1.77 | +701% | — | 10-K Mar-27-26; 8-K Apr-1-26 (FDA sNDA accepted) | Nov-14-26 (PDUFA) | N/A | Y ($8.50 median, 12 analysts) | N |

_Screened out (price >$5): AGPU ($13.61 post-contract surge), SOUN ($7.85), TNXP ($13.95), INBX ($84.08)_
_Screened out (below 20-day MA / bearish signal): BBAI ($3.79, 12/12 sell signals, 20DMA $5.96), BZAI ($2.14, −7.56% today)_
_Screened out (RVOL <2.0): OABI ($1.64, Apr-16 vol 386K vs avg 494K = RVOL ~0.78)_

---

### 2026-04-23 Morning Scan

| Ticker | Price | RVOL | Dollar Vol | Spread | Tech Score | Above SMA9 | Above SMA20 | Above SMA200 | Above VWAP | Resistance | 52W High | Upside% | Flags | Catalyst (SEC) | FDA Date | Earnings | Analyst | Insider |
|--------|-------|------|-----------|--------|-----------|-----------|------------|-------------|-----------|-----------|---------|---------|-------|----------------|----------|----------|---------|---------|
| GRCE | $4.58 | ~3.5x | ~$4.2M | ~1.8% | 4/5 | Y | Y | N | Y | $5.18 | $5.18 | +13% | TODAY CATALYST — PDUFA APR-23-26; EARNINGS JUN-23-26 | NDA accepted 8-K Aug-22-25; PDUFA Apr-23-26 confirmed; Q3-2026 10-Q filed | Apr-23-26 (TODAY) | Jun-23-26 | Y ($12.00 avg, 2 analysts) | N |
| ATNM | $1.35 | ~2.8x | ~$1.15M | ~2.5% | 4/5 | Y | Y | Y | Y | $1.77 | $2.56 | +31% | EARNINGS MAY-08-26 | 10-K Mar-30-26; 8-K/A Mar-26-26; AACR data Apr-21-26 | N/A | May-08-26 | Y ($4.50–$5.00 avg; Cantor $21 PT) | N |
| SIDU | $4.12 | ~3.1x | ~$93M | ~1.5% | 5/5 | N | Y | N | N | $5.20 | $5.31 | +26% | HIGH DILUTION RISK (424B5 active offering Apr-1-26); EARNINGS MAY-20-26 | SHIELD IDIQ 8-K Dec-22-25; 424B5 Apr-1-26; FY2025 10-K confirmed | N/A | May-20-26 | Y ($10.20 ThinkEquity Strong Buy; 1 analyst) | N |

_Screened out (below 20-day MA): BTAI ($1.18 vs SMA20 $1.47 — now failing MA filter; flag reversed from Apr-22 scan); INO ($1.14, below MA, dilutive offering Apr-2-26 12.5M shares + warrants = HIGH DILUTION RISK)_
_Screened out (RVOL <2.0): DNN ($3.87, RVOL ~0.61 — 26M vol vs 42M avg); COCP ($1.50, RVOL ~0.13 — 127K vs 970K avg)_
_Screened out (price >$5): RCAT ($12.34–$14.12), POET (>$10), BCAB ($5.84)_
_Note on CDXS: Down ~8% today ($2.40 vs prior $2.62); approaching 20-day MA support — monitor for Apr-30 earnings catalyst. Tech Score unchanged at 3/5 pending intraday resolution._
_Second-pass screened out (price >$5): UUUU ($20.52); WISH/LOGC ($8.75, now OTC)_
_Second-pass screened out (RVOL <2.0): EDIT ($2.21, RVOL ~0.02 — ~34K vs 1.73M avg)_
...
| Ticker | Price | RVOL | Dollar Vol | Spread | Tech Score | Above SMA9 | Above SMA20 | Above SMA200 | Above VWAP | Resistance | 52W High | Upside% | Flags | Catalyst (SEC) | FDA Date | Earnings | Analyst | Insider |
|--------|-------|------|-----------|--------|-----------|-----------|------------|-------------|-----------|-----------|---------|---------|-------|----------------|----------|----------|---------|---------|
| CDXS | ~$2.40 | ~1.7x est | ~$1.4M est | ~1.5% | 4/5 | Y | Y | Y (crossed Apr-22) | Y est | $2.60 | $3.87 | +61% to 52W high | RVOL BORDERLINE (~1.5–1.9x); EARNINGS <7D (APR-30-26) ⚠️ CORRECTED — EARNINGS NOW MAY-7-26; 200-DAY MA CROSS APR-22 | 10-K/Q confirmed; EPS beat +357% Q4-2025 (Mar-11-26 8-K); Q1-2026 earnings confirmed May-7-26 after close | N/A | ~~Apr-30-26~~ **May-7-26** | Y ($6.10–$8.00 avg; Cantor PT $11; consensus Hold w/ Buy skew; 6 analysts) | N (institutional 13G filings; Opaleye 10.45M shares) |
...
_Second-pass screen (3:30 PM run) — Screened out (RVOL <2.0): SRFM ($1.13 Apr-23; vol 7.62M vs avg 6.91M = RVOL ~1.10 — air-mobility AI platform, 7 consecutive quarters guidance beat, but volume insufficient); DVLT ($0.71 Apr-24; vol 15.51M vs avg 34.13M = RVOL ~0.45 — fell from 52W high $4.10, declining trend); ACIU ($2.895 Apr-24; vol 81.6K vs avg 237.6K = RVOL ~0.34 — next catalyst ACI-24 Part 1 data May-1-26; Eli Lilly license amendment CHF 10M Apr-2026; 2-analyst Strong Buy, PT $10; RVOL too low to qualify); BTAI ($1.11 Apr-24; vol 828K vs avg 1.07M = RVOL ~0.77 — volume faded from Apr-22 RVOL ~2.1; PDUFA Nov-14-26 unchanged; screened out from active scan); LCTX ($1.71 Apr-24 +4.27%; vol ~164K vs avg ~1M = RVOL ~0.16 — cash $42.3M runway to Q1-2027, B. Riley PT $4 raised Mar-25-26, SAB formed Apr-8-26, Phase 2a OpRegen/OPC1 intact; RVOL far below threshold)_
_Second-pass screen (3:30 PM run) — Screened out (price >$5): BBGI ($24.11 Apr-24, +380% recent surge — well above $0.50–$5.00 range; note vol 138K vs avg 3.86M = RVOL ~0.04, illiquid spike); TLRY ($7.65 Apr-22 — cannabis, above price floor); FDMT ($9.81 Apr-10 — 4D Molecular Therapeutics; note: 5/5 Strong Entry conditions met per MarketsHost screen incl. golden cross, bullish MACD, rising OBV, bullish DI, breakout; PRISM 2-year readout May-1-26; short float 21.1% = SQUEEZE CANDIDATE; 7 analysts Strong Buy avg PT $31.71; earnings May-7-26; price disqualifies under $5.00 screen — monitor if price retraces into range)_
_Second-pass scan summary (Apr-24 3:30 PM): No new qualifying candidates identified beyond CDXS and IFRX already logged. RVOL broadly failing across biotech universe into close. Strongest near-term setups (FDMT, ACIU) excluded by price range or RVOL. CDXS (EARNINGS MAY-7 [corrected], 200-day MA cross, Cantor PT $11) and IFRX (Guggenheim Buy/$14 reaffirmed Apr-21-26, RVOL ~2.3x) remain the two active afternoon entries for today. Sector mix: 100% Biotech; no AI/Chip/Energy/Defence names qualified._
